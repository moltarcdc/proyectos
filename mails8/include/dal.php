...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("oc_users");
}
...
{
	var $oc_audit;
	var $oc_clndr_calendars;
	var $oc_clndr_objects;
	var $oc_conf_notif_avanz;
	var $oc_preferences;
	var $oc_searches;
	var $oc_uggroups;
	var $oc_ugmembers;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "oc_audit", "varname" => "oc_audit", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_clndr_calendars", "varname" => "oc_clndr_calendars", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_clndr_objects", "varname" => "oc_clndr_objects", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_conf_notif_avanz", "varname" => "oc_conf_notif_avanz", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_preferences", "varname" => "oc_preferences", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_searches", "varname" => "oc_searches", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_uggroups", "varname" => "oc_uggroups", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_ugmembers", "varname" => "oc_ugmembers", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_ugrights", "varname" => "oc_ugrights", "connId" => "l8000494_neocloud_at_localhost");
		$this->lstTables[] = array("name" => "oc_users", "varname" => "oc_users", "connId" => "l8000494_neocloud_at_localhost");
	}
