...
$ovrd = func_Override("auditoria_print.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("print", "PurificCity", "MobileCity");
$layout->version = 2;
...
$page_layouts["auditoria_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "oc_audit" );
