...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("oc_users", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("oc_clndr_objects" == $table) 
		return "objetosdecalendario";
	...
	if("admin_users" == $table) 
		return "admin_users";
	if("oc_conf_notif_avanz" == $table) 
		return "confnotifavanzadas";
	if("oc_audit" == $table) 
		return "auditoria";
	if("enviomail" == $table) 
		return "enviomail";
...
{	
	...
	if(!$shortTName)
		return false;
	if("objetosdecalendario" == $shortTName) 
		return "oc_clndr_objects";
	if("admin_rights" == $shortTName) 
		return "admin_rights";
	if("oc_users" == $shortTName) 
		return "oc_users";
	if("admin_members" == $shortTName) 
		return "admin_members";
	if("admin_users" == $shortTName) 
		return "admin_users";
	if("confnotifavanzadas" == $shortTName) 
		return "oc_conf_notif_avanz";
	if("auditoria" == $shortTName) 
		return "oc_audit";
	if("enviomail" == $shortTName) 
		return "enviomail";
}
