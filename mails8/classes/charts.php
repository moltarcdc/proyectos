...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("oc_clndr_objects" == $this->chrt_array['tables'][0])
			return true;
		if("oc_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("oc_users" == $this->chrt_array['tables'][0])
			return true;
		if("oc_users" == $this->chrt_array['tables'][0])
			return true;
		if("oc_users" == $this->chrt_array['tables'][0])
			return true;
		if("oc_conf_notif_avanz" == $this->chrt_array['tables'][0])
			return true;
		if("oc_audit" == $this->chrt_array['tables'][0])
			return true;
		if("oc_conf_notif_avanz" == $this->chrt_array['tables'][0])
			return true;
		return false;
