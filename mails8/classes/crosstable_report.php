...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("oc_clndr_objects" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_conf_notif_avanz" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_audit" == $this->xml_array['tables'][0])
			$isDB = true;
		if("oc_conf_notif_avanz" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
