...
$ovrd = func_Override("auditoria_search.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("search", "PurificCity", "MobileCity");
$layout->version = 2;
...
$page_layouts["auditoria_search"] = $layout;

}
else
{

$layout = new TLayout("search2", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
...
$params['shortTableName'] = 'auditoria';
