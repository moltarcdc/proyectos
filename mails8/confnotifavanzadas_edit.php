...
$ovrd = func_Override("confnotifavanzadas_edit.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("edit", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
$layout->container_properties["fields"] = array(  );
$layout->containers["fields"][] = array("name"=>"editheader_mobile", 
	"block"=>"", "substyle"=>2  );
...
$page_layouts["confnotifavanzadas_edit"] = $layout;

}
else
{

$layout = new TLayout("edit2", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
