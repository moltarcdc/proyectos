...
$ovrd = func_Override("auditoria_export.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("export", "PurificCity", "MobileCity");
$layout->version = 2;
...
$page_layouts["auditoria_export"] = $layout;

}
else
{

$layout = new TLayout("export2", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["export"] = array();
$layout->container_properties["export"] = array(  );
