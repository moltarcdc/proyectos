...
$ovrd = func_Override("confnotifavanzadas_add.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("add", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
$layout->container_properties["fields"] = array(  );
$layout->containers["fields"][] = array("name"=>"addheader_mobile", 
	"block"=>"", "substyle"=>2  );
...
$page_layouts["confnotifavanzadas_add"] = $layout;

}
else
{

$layout = new TLayout("add2", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
