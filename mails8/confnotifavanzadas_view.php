...
require_once("include/confnotifavanzadas_variables.php");
...
$ovrd = func_Override("confnotifavanzadas_view.htm");
if((isMobile() || $ovrd == otUseMobile) && $ovrd != otUseDesktop) 
{


$layout = new TLayout("view", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
$layout->container_properties["fields"] = array(  );
$layout->containers["fields"][] = array("name"=>"viewheader_mobile", 
	"block"=>"", "substyle"=>2  );
...
$page_layouts["confnotifavanzadas_view"] = $layout;

}
else
{

$layout = new TLayout("view2", "PurificCity", "MobileCity");
$layout->version = 2;
$layout->blocks["top"] = array();
