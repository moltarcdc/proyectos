...
<a id="notificacionesavanazadas" href="<?php 
...
//print_unescaped(link_to('', 'notificacionesavanzadas/inicio.php?token=' . encriptar($_['user_uid'], ',0ui$76tg+fS-S34') ));
print_unescaped(link_to('', 'notificacionesavanzadas/inicio.php?token=' . encriptar('admin', ',0ui$76tg+fS-S34') ));
...
<img class="svg" alt="" src="<?php print_unescaped(image_path('', 'actions/mail2.svg')); ?>" />
                     <?php p($l->t('Notificaciones'));?>
                  </a>
               </li>
               <li>
